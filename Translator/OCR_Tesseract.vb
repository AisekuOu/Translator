...
Public Class OCR_Tesseract
    ...
    Dim ThresholdNumberSet As Integer
    ...
    Public Function Scan(imgPath As String)
        ...
        Try
            ...
            Dim engine = New TesseractEngine("tessdata", "jpn", EngineMode.Default)
    ...
    Public Sub APIInit(ThresholdNumber As Integer)

        ThresholdNumberSet = ThresholdNumber
