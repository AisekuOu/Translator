...
Public Class TencentAPI_Translate
    ...
    Public Function TranslateString(TranslateSource As String)
        ...
        Dim url As String = "https://api.ai.qq.com/fcgi-bin/nlp/nlp_texttranslate"
    ...
    Private Function Post(url As String, dic As Dictionary(Of String, String))
        ...
        Try
            ...
            RaiseEvent loggerPrint("TencentAPI_Translate" + vbCrLf + vbCrLf + result + vbCrLf + vbCrLf)

            Dim temp As String = result

            ResultString = ""

            If temp.IndexOf("target_text") < 0 Then

                ResultCode = 0

            Else

                temp = temp.Substring(temp.IndexOf("target_text")).Substring(15)

                ResultString = temp.Substring(0, temp.IndexOf(Chr(34)))
        ...
        Catch ex As Exception
            ...
            RaiseEvent loggerPrint("TencentAPI_Translate" + vbCrLf + vbCrLf + ex.ToString + vbCrLf + vbCrLf)
